...
router.get('/', requireRole('users', 'view'), async (_req: Request, res: Response): Promise<void> => {
...
router.post('/', requireRole('users', 'manage'), async (req: Request, res: Response): Promise<void> => {
...
router.patch('/:id', requireRole('users', 'manage'), async (req: Request, res: Response): Promise<void> => {
