...
export const pmProjects = pgTable('pm_projects', {
  ...
  pmCustomerId: uuid('pm_customer_id').references(() => pmCustomers.id, { onDelete: 'set null' }),
  pmFacilityId: uuid('pm_facility_id').references(() => pmFacilities.id, { onDelete: 'set null' }),
