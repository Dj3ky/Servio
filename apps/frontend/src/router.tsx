...
const ChangelogActivityPage = lazy(() => import('@/extensions/changelog/pages/ChangelogActivityPage'));
...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'changelog/activity', element: withSuspense(<ChangelogActivityPage />) },
    ],
  },
]);
